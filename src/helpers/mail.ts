...
//                                                                     <br>
//                                                                     <br>
//                                                                     The Kaldari Realestate App Team
//                                                                 </p>
...
//                 }
//             },
//             ReplyToAddresses: ["master.semicolon@gmail.com"],
//             Source: "master.semicolon@gmail.com",
//         };
...
//                                                                     Hi ${user.name} 
//                                                                     <br>
//                                                                     Someone, hopefully you, has requested to new account in Photographer app
//                                                                     <br>
//                                                                     OTP will expire in 10 minutes.
//                                                                     <br>
//                                                                     Verification code: ${otp}
                                                ...
                                                <tr>
                                                    <td style="padding:0 35px;">
                                                        ...
                                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                            Hi ${user.name} 
                                                            <br>
                                                            Someone, hopefully you, has requested to new account in Kaldari Realesate app
                                                            <br>
                                                            OTP will expire in 10 minutes.
                                                            <br>
                                                            Verification code: ${otp}
